...
-->
 ...
 <p class="author">Tác giả <xsl:for-each select="marc:datafield[(@tag=100 or @tag=700 or @tag=110 or @tag=710 or @tag=111 or @tag=711) and @ind1!='z']">
 <a>
 <xsl:choose>
...
<xsl:if test="$DisplayIconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/book_link.png" class="materialtype" title="Sách" alt="Sách" /> Bộ</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" alt="Sách" class="materialtype" title="Sách" /> Sách</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="ÂPĐK" title="ÂPĐK" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/newspaper.png" /> Continuing resource</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/book_open.png" title="Bài báo" class="materialtype" alt="Bài báo" /> Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img alt="Sách" class="materialtype" title="Sách" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" /> Sách</xsl:when>
 <xsl:when test="$leader6='o'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" alt="Bộ công cụ" title="Bộ công cụ" class="materialtype" /> Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'"><img alt="Vật liệu hỗn hợp" title="Vật liệu hỗn hợp" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" />Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/computer_link.png" title="File máy tính" class="materialtype" alt="File máy tính" /> File máy tính</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="Bản đồ" class="materialtype" title="Bản đồ" src="/intranet-tmpl/prog/img/famfamfam/silk/map.png" /> Bản đồ</xsl:when>
 <xsl:when test="$leader6='g' or $leader6='k' or $leader6='r'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/film.png" class="materialtype" title="Visual material" alt="Visual material" /> Visual material</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="Phạm vi" title="Phạm vi" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/music.png" /> Phạm vi</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="Âm nhạc" class="materialtype" title="Âm nhạc" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" /> Âm nhạc</xsl:when>
 <xsl:when test="$leader6='j'"><img class="materialtype" title="Âm nhạc" alt="Âm nhạc" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" /> Âm nhạc</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <span class="results_summary description"><span class="label">Thông tin mô tả: </span>
 <xsl:for-each select="marc:datafield[@tag=300]">
 <xsl:call-template name="chopPunctuation">
 <xsl:with-param name="chopString">
 <xsl:call-template name="subfieldSelect">

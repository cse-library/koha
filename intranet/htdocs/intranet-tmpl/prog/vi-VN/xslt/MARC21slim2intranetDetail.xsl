...
<xsl:stylesheet version="1.0"
 ...
 <span class="results_summary uniform_title"><span class="label">Nhan đề đồng nhất: </span>
...
<!-- Other classification -->
 ...
 <span class="results_summary"><span class="label">Xem hiển thị OPAC: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="marc:datafield[@tag=999]/marc:subfield[@code='c']"/></xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>Mở trong cửa sổ mới</a>.
 </span>
 </xsl:if>

...
<xsl:stylesheet version="1.0"
 ...
 <xsl:otherwise>Tùng thư</xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'">Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'">Sách</xsl:when>
 <xsl:when test="$leader6='o'">Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'">Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'">File máy tính</xsl:when>
 ...
 <xsl:when test="$leader6='i'">Âm nhạc</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">Phạm vi</xsl:when>
 </xsl:choose>
 </xsl:variable>
 ...
 <xsl:attribute name="typeof"><xsl:value-of select='$schemaOrgType' /> Sản phẩm</xsl:attribute>
 ...
 <xsl:with-param name="label">Thông tin mô tả: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>
 ...
 <span class="label">Thông tin sáng chế: </span>
 ...
 <span class="results_summary other_title"><span class="label">Nhan đề khác: </span>
 ...
 <span class="results_summary translated_title"><span class="label">Nhan đề chuyển đổi: </span>
 ...
 <xsl:with-param name="delimeter"> Và </xsl:with-param>
...
<!-- Image processing code added here, takes precedence over text links including y3z text -->
 ...
 <span class="label">Nội dung thiếu:</span>
 </xsl:when>
 <xsl:when test="@ind1=2">
 <span class="label">Nội dung thành phần:</span>
 </xsl:when>
 <xsl:otherwise>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>Chủ đề: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>Bài phê bình: </xsl:text></xsl:when>
 ...
 <span class="results_summary holdings_note"><span class="label">Ghi chú sở hữu </span>
 ...
 <span class="label">Thay thế:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Thay thế từng phần:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Được thành lập bởi: ... và: ...</span>
 </xsl:when>
 ...
 <span class="label">Được tách từ:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:when test="@ind2=2">
 <span class="label">Thay thế bởi:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Thay thế từng phần bởi:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 ...
 <xsl:when test="@ind2=6">
 <span class="label">Chia thành .. và ...:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Được sát nhập với ... để tạo thành ...</span>
 </xsl:when>
 <xsl:when test="@ind2=8">
 <span class="label">Quay về:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:otherwise><xsl:attribute name="property">Người đóng góp</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 <xsl:when test="substring(@tag, 2, 1)='0'">
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Music'"><xsl:attribute name="typeof">Nhóm âm nhạc</xsl:attribute></xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Cá nhân</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Cơ quan, tổ chức</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>

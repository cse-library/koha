...
-->
 ...
 <img alt="Đĩa quang" class="format" title="Đĩa quang" src="/opac-tmpl/lib/famfamfam/silk/cd.png" />
 </xsl:if>
 ...
 <img title="Biểu đồ" class="format" alt="Biểu đồ" src="/opac-tmpl/lib/famfamfam/silk/chart_curve.png" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='c']">
 Tranh dán </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='d']">
 <img src="/opac-tmpl/lib/famfamfam/silk/pencil.png" alt="Tranh họa tiết" class="format" title="Tranh họa tiết" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='o']">
 <img src="/opac-tmpl/lib/famfamfam/silk/note.png" class="format" title="Thẻ nhớ" alt="Thẻ nhớ" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='e']">
 <img title="Tranh vẽ" class="format" alt="Tranh vẽ" src="/opac-tmpl/lib/famfamfam/silk/paintbrush.png" />
 </xsl:if>
 ...
 <img src="/opac-tmpl/lib/famfamfam/silk/picture.png" title="Ảnh" class="format" alt="Ảnh" />
 </xsl:if>
 ...
 <img class="format" title="Ký hiệu âm nhạc" alt="Ký hiệu âm nhạc" src="/opac-tmpl/lib/famfamfam/silk/script.png" />
 </xsl:if>
 ...
 <img title="Đĩa nhạc" class="format" alt="Đĩa nhạc" src="/opac-tmpl/lib/famfamfam/silk/cd.png" />
 </xsl:if>
 ...
 <img src="/opac-tmpl/lib/famfamfam/silk/magnifier.png" class="format" title="In khổ lớn" alt="In khổ lớn" />
 </xsl:if>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img src="/opac-tmpl/lib/famfamfam/silk/book_link.png" title="Sách" class="materialtype" alt="Sách" /> Bộ</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img src="/opac-tmpl/lib/famfamfam/silk/book.png" alt="Sách" title="Sách" class="materialtype" /> Sách</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="ÂPĐK" class="materialtype" title="ÂPĐK" src="/opac-tmpl/lib/famfamfam/silk/newspaper.png" /> Continuing resource</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img alt="Bài báo" class="materialtype" title="Bài báo" src="/opac-tmpl/lib/famfamfam/silk/book_open.png" /> Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img class="materialtype" title="Sách" alt="Sách" src="/opac-tmpl/lib/famfamfam/silk/book.png" /> Sách</xsl:when>
 <xsl:when test="$leader6='o'"><img src="/opac-tmpl/lib/famfamfam/silk/report_disk.png" class="materialtype" title="Bộ công cụ" alt="Bộ công cụ" /> Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'"><img src="/opac-tmpl/lib/famfamfam/silk/report_disk.png" class="materialtype" title="Vật liệu hỗn hợp" alt="Vật liệu hỗn hợp" />Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'"><img src="/opac-tmpl/lib/famfamfam/silk/computer_link.png" class="materialtype" title="File máy tính" alt="File máy tính" /> File máy tính</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img src="/opac-tmpl/lib/famfamfam/silk/map.png" alt="Bản đồ" class="materialtype" title="Bản đồ" /> Bản đồ</xsl:when>
 <xsl:when test="$leader6='g' or $leader6='k' or $leader6='r'"><img title="Visual material" class="materialtype" alt="Visual material" src="/opac-tmpl/lib/famfamfam/silk/film.png" /> Visual material</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img src="/opac-tmpl/lib/famfamfam/silk/music.png" class="materialtype" title="Phạm vi" alt="Phạm vi" /> Phạm vi</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="Âm nhạc" class="materialtype" title="Âm nhạc" src="/opac-tmpl/lib/famfamfam/silk/sound.png" /> Âm nhạc</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="Âm nhạc" class="materialtype" title="Âm nhạc" src="/opac-tmpl/lib/famfamfam/silk/sound.png" /> Âm nhạc</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img src="/opac-tmpl/lib/famfamfam/silk/database.png" title="Cơ sở dữ liệu" class="format" alt="Cơ sở dữ liệu" />
 </xsl:when>
 ...
 Tiểu sử <img alt="Tiểu sử" title="Tiểu sử" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/silk/text_list_bullets.png" />
 </xsl:when>
 ...
 <img src="/opac-tmpl/lib/famfamfam/silk/report.png" alt="Báo cáo kỹ thuật" title="Báo cáo kỹ thuật" class="natureofcontents" />
 </xsl:when>
 ...
 <img alt="Cơ sở dữ liệu" class="format" title="Cơ sở dữ liệu" src="/opac-tmpl/lib/famfamfam/silk/database.png" />
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <img title="Phông chữ" class="format" alt="Phông chữ" src="/opac-tmpl/lib/famfamfam/silk/font.png" />
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <img title="Trò chơi" class="format" alt="Trò chơi" src="/opac-tmpl/lib/famfamfam/silk/controller.png" />
 </xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img alt="Hồi ký, tiểu sử" title="Hồi ký, tiểu sử" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/silk/user.png" />
 </xsl:if>
